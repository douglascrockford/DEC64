...
extern dec64 dec64_acos(dec64 x);
extern dec64 dec64_asin(dec64 x);
extern dec64 dec64_atan(dec64 x);
extern dec64 dec64_atan2(dec64 y, dec64 x);
extern dec64 dec64_cos(dec64 x);
extern dec64 dec64_exp(dec64 x);
...
extern dec64 dec64_sin(dec64 x);
extern dec64 dec64_root(dec64 degree, dec64 radicand);
extern dec64 dec64_sqrt(dec64 x);
extern dec64 dec64_tan(dec64 x);
