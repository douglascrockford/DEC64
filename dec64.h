...
#define DEC64_NULL          (0x0000000000000080LL)
#define DEC64_TRUE          (0x0000000000000380LL)
#define DEC64_FALSE         (0x0000000000000280LL)
