...
; nothing more to add.
    ...
    lea     r9,[rel power]
    mov     r9,qword[r9, r2*8]   ; r9 is the power of ten
    cqo                     ; sign extend r0 into r2
...
inc_negative_exponent:
    ...
    lea     r9,[rel power]
    mov     r0,qword[r9, r8*8]   ; r0 is 10^(-exponent)
...
floor_begin:
    ...
    lea     r10,[rel power]
    mov     r10,qword [r10, r8*8] ; r10 is the power of ten
    cqo                     ; sign extend r0 into r2
...
; false. Otherwise, return true.
    ...
    jae     return_zero
    lea     r9,[rel power]
    mov     r10,qword [r9, r8*8]  ; r10 is 10^-exponent
    cqo                     ; sign extend r0 into r2
